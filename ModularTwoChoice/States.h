...
class StateRotateStepper1 : public OneOffState {
  public:
    StateRotateStepper1() { }; 
    void run();
};
...
class StateRotateStepper2 : public OneOffState {
  public:
    StateRotateStepper2() { }; 
    void run();
};

class StateRewardL : public OneOffState {
  public:
    StateRewardL() { }; 
    void run(unsigned long time);
};

class StateRewardR : public OneOffState {
  public:
    StateRewardR() { }; 
    void run(unsigned long time);
};

class StateTrialStart : public OneOffState {
  public:
    StateTrialStart() { }; 
    void run();
};

class StateWaitToStartTrial : public ConditionalState {
  protected:
    bool end_condition();
    void s_finish();
